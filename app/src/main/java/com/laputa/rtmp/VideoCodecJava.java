...
public class VideoCodecJava extends Thread {

    private Show screenLive;
    ...
    public VideoCodecJava(Show screenLive) {
...
//                        ("csd-1");
                ...
                RTMPPacket rtmpPackage = new RTMPPacket(outData,
                        RTMPPacket.RTMP_PACKET_TYPE_VIDEO,tms
                        );
    ...
    public void startLive(MediaProjection mediaProjection) {
        ...
        try {
            ...
            mediaCodec = MediaCodec.createByCodecName(VideoCodec.selectSupportCodec(MediaFormat.MIMETYPE_VIDEO_AVC).getName());
